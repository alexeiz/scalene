...
class Scalene():
    ...
    malloc_sampling_rate          = 16 * 1024 * 1024  # we get signals after this many bytes are allocated.
                                                      # NB: MUST BE IN SYNC WITH include/sampleheap.hpp!
    free_sampling_rate            = 16 * 1024 * 1024  # as above, for frees.
    ...
    def main():
        ...
        Scalene.next_output_time = 0 # Scalene.gettime() + Scalene.output_profile_interval
        try:
